/*
   ...
   SC INI DITULIS ULANG OLEH FALLXD
   JANGAN LUPA SUBSCRIBE CHANNEL FALLXD
   DAN DI FIX ULANG OLEH FALLXD
                                                              */
...
browser: ['FallZx', 'safari', '1.0.0'],
auth: state
})

store.bind(lynzz.ev)
console.log(color(figlet.textSync('FallZx BOTZ', {
font: 'Standard',
